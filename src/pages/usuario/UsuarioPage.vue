<template>
  <q-page padding>
    ...
    <template v-slot:top>
      ...
      <q-space/>
      <q-btn color="primary" label="Novo" :to="{ name: 'usuario-adicionar'}"/>
    </template>
    <template v-slot:body-cell-actions="props">
      <q-td :props="props">
        <q-btn class="q-ma-sm" icon="edit" color="secondary" dense size="md" @click="handleEditUsuario(props.row.id)"/>
        <q-btn class="q-ma-auto" icon="delete" color="negative" dense size="md" @click="handleDeleteUsuario(props.row.id)"/>
      </q-td>
    </template>
    </q-table>
  </q-page>
...
export default defineComponent({
  ...
  setup () {
    ...
    const columns = [
      { name: 'id', field: 'idUsuario', label: 'Id', sortable: true, align: 'left' },
